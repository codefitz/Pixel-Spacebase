...
/*
	...
	This means that an object can just ask for "name" rather than, say, "items.weapon.enhancements.death.name"
 */
public class Messages {
    ...
    private static String[] prop_files = new String[]{
            ...
            "com.wafitz.pixelspacebase.messages.mines.mines",
            ...
            "com.wafitz.pixelspacebase.messages.misc.misc"
    };

    static {
        setup(PixelSpacebase.language());
    }
    ...
    public static String get(Class c, String k, Object... args) {
        String key;
        if (c != null) {
            key = c.getName().replace("com.wafitz.pixelspacebase.", "");
            key += "." + k;
        } else
            key = k;
