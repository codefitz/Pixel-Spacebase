...
public class EngineeringBossLevel extends Level {
    ...
    public String tilesTex() {
        return Assets.TILES_ENGINEERING;
    }

    @Override
    public String waterTex() {
        return Assets.WATER_ENGINEERING;
    }
    ...
    public void press(int cell, Char hero) {
        ...
        if (!enteredArena && outsideEntraceRoom(cell) && hero == SpacebaseRun.hero) {

            enteredArena = true;
            seal();

            Mob boss = Bestiary.mob(SpacebaseRun.depth);
    ...
    public Heap drop(Item item, int cell) {
        ...
        if (!keyDropped && item instanceof MasterKeycard) {
    ...
    public String tileName(int tile) {
        switch (tile) {
            case Terrain.LIGHTEDVENT:
                return Messages.get(EngineeringLevel.class, "lightedvent_name");
            case Terrain.OFFVENT:
                return Messages.get(EngineeringLevel.class, "off_vent_name");
            case Terrain.WATER:
                return Messages.get(EngineeringLevel.class, "water_name");
            default:
    ...
    public String tileDesc(int tile) {
        switch (tile) {
            case Terrain.WATER:
                return Messages.get(EngineeringLevel.class, "water_desc");
            case Terrain.ENTRANCE:
                return Messages.get(EngineeringLevel.class, "entrance_desc");
            case Terrain.EXIT:
                return Messages.get(EngineeringLevel.class, "exit_desc");
            case Terrain.OFFVENT:
                return Messages.get(EngineeringLevel.class, "off_vent_desc");
            case Terrain.WALL_DECO:
                return Messages.get(EngineeringLevel.class, "wall_deco_desc");
            case Terrain.BOOKSHELF:
                return Messages.get(EngineeringLevel.class, "bookshelf_desc");
            default:
    ...
    public Group addVisuals() {
        super.addVisuals();
        EngineeringLevel.addCavesVisuals(this, visuals);
        return visuals;
    }
}
