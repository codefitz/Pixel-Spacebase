...
import com.wafitz.pixelspacebase.actors.mobs.npcs.ImpPartsBot;
...
public class PartsShop extends Painter {
    ...
    private static void placeShopkeeper(Level level, Room room) {
        ...
        Mob shopkeeper = level instanceof LastShopLevel ? new ImpPartsBot() : new PartsBot();
        shopkeeper.pos = pos;
