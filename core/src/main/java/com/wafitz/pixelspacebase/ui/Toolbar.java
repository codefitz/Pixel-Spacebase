...
public class Toolbar extends Component {
    ...
    protected void layout() {
        ...
        int slots = PixelSpacebase.quickSlots();
        ...
        for (int i = 0; i <= 3; i++) {
            ...
            if (slots == 4 && width < 150) {
                if (width < 139) {
                    if ((PixelSpacebase.flipToolbar() && i == 3) ||
                            (!PixelSpacebase.flipToolbar() && i == 0)) {
                    ...
                    if (i == 0 && !PixelSpacebase.flipToolbar() ||
                            i == 3 && PixelSpacebase.flipToolbar()) {
                        btnQuick[i].border(0, 2);
                        btnQuick[i].frame(106, 0, 19, 24);
                    } else if (i == 0 && PixelSpacebase.flipToolbar() ||
                            i == 3 && !PixelSpacebase.flipToolbar()) {
        ...
        float right = width;
        switch (Mode.valueOf(PixelSpacebase.toolbarMode())) {
            case SPLIT:
                btnWait.setPos(x, y);
