...
public class Archs extends Component {
    ...
    private static final float SPEED_SCRIPT = 10f;
    ...
    protected void layout() {
        ...
        arcsBg.offset(arcsBg.texture.logicalWidth() / 4 - (width % arcsBg.texture.logicalWidth()) / 2, 0);

        arcsFg.size(width, height);
        arcsFg.offset(arcsFg.texture.logicalWidth() / 4 - (width % arcsFg.texture.logicalWidth()) / 2, 0);
    }
