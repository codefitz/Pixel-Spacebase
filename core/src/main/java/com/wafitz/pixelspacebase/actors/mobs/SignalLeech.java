...
import com.wafitz.pixelspacebase.sprites.SignalLeechSprite;
...
public class SignalLeech extends Mob implements Callback {

    private static final float TIME_TO_ZAP = 1f;

    {
        spriteClass = SignalLeechSprite.class;
    ...
    public Item createLoot() {
        ...
        if (loot instanceof HealingTech) {
            ...
            if (Random.Int(10) - SpacebaseRun.limitedDrops.warlockHP.count < 0) {
                ...
                SpacebaseRun.limitedDrops.warlockHP.count++;
