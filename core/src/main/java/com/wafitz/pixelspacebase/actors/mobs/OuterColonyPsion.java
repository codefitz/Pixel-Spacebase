...
import com.wafitz.pixelspacebase.sprites.OuterColonyPsionSprite;
...
public class OuterColonyPsion extends Mob implements Callback {

    private static final float TIME_TO_ZAP = 1f;

    {
        spriteClass = OuterColonyPsionSprite.class;
    ...
    protected boolean doAttack(Char enemy) {
        ...
        if (SpacebaseRun.level.distance(pos, enemy.pos) <= 1) {
