...
import com.wafitz.pixelspacebase.sprites.JedaKnightSprite;
...
public class JedaKnight extends Mob {

    {
        spriteClass = JedaKnightSprite.class;
        ...
        if (enemy == SpacebaseRun.hero) {
            ...
            if (weapon != null && !(weapon instanceof Knuckles) && !weapon.malfunctioning) {
                ...
                if (--hitsToDisarm == 0) {
                    ...
                    SpacebaseRun.level.drop(weapon, hero.pos).sprite.drop();
