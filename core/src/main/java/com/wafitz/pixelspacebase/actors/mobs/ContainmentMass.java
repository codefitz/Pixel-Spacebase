...
import com.wafitz.pixelspacebase.sprites.ContainmentMassSprite;
...
public class ContainmentMass extends Mob {

    {
        spriteClass = ContainmentMassSprite.class;
    ...
    public void die(Object cause) {
        ...
        for (Mob mob : (Iterable<Mob>) SpacebaseRun.level.mobs.clone()) {
