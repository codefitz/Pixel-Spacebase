...
public class Module extends KindofMisc {
    ...
    public static void initGems() {
        handler = new ItemStatusHandler<>((Class<? extends Module>[]) rings, gems);
    }
    ...
    public static void restore(Bundle bundle) {
        handler = new ItemStatusHandler<>((Class<? extends Module>[]) rings, gems, bundle);
    }
    ...
    public String info() {
        ...
        if (cursed && isEquipped(Dungeon.hero)) {
            ...
            desc += "\n\n" + Messages.get(Module.class, "cursed_worn");

        } else if (cursed && cursedKnown) {

            desc += "\n\n" + Messages.get(Module.class, "curse_known");
