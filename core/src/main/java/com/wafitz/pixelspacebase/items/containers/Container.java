...
public class Container extends Item implements Iterable<Item> {
    ...
    public void execute(Hero hero, String action) {
        ...
        if (action.equals(AC_OPEN)) {
            ...
            GameScene.show(new WndContainer(this, null, WndContainer.Mode.ALL, null));
    ...
    public boolean collect(Container container) {
        ...
        if (super.collect(container)) {
            ...
            Badges.validateAllContainersMade(this);
    ...
    public boolean contains(Item item) {
        for (Item i : items) {
            if (i == item) {
                return true;
            } else if (i instanceof Container && ((Container) i).contains(item)) {
                return true;
            }
        }
        return false;
        ...
        public Item next() {
            if (nested != null && nested.hasNext()) {
                ...
                if (item instanceof Container) {
                    nested = ((Container) item).iterator();
                }
