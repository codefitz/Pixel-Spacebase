...
abstract class InventoryUpgrade extends Upgrade {
    ...
    // wafitz.v5: Probably I will put this back in but with a non-optional "Upgrade identifies itself"
    ...
    protected static WndContainer.Listener itemSelector = new WndContainer.Listener() {
        ...
        public void onSelect(Item item) {
            if (item != null) {
                ...
                ((InventoryUpgrade) curItem).onItemSelected(item);
                ((InventoryUpgrade) curItem).readAnimation();
