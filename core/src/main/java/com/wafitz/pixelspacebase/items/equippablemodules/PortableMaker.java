...
public class PortableMaker extends EquippableModule {
    ...
    {
        image = ItemSpriteSheet.PORTABLE_MAKER;
    ...
    public void execute(Hero hero, String action) {
        ...
        if (action == AC_SET || action == AC_RETURN) {
            ...
            if (SpacebaseRun.bossLevel()) {
                hero.spend(PortableMaker.TIME_TO_USE);
        ...
        if (action == AC_ZAP) {
            ...
            curUser = hero;
            int chargesToUse = SpacebaseRun.depth > 20 ? 2 : 1;
            ...
            returnDepth = SpacebaseRun.depth;
            returnPos = hero.pos;
    ...
    private CellSelector.Listener zapper = new CellSelector.Listener() {
        ...
        public void onSelect(Integer target) {
            ...
            Camoflage.dispel();
            charge -= SpacebaseRun.depth > 20 ? 2 : 1;
            updateQuickslot();
            ...
            if (Actor.findChar(target) == curUser) {
                ...
                if (ch == curUser) {
                    ...
                    EnergyBeam.force(curUser.sprite.parent, bolt.sourcePos, bolt.collisionPos, new Callback() {
                        @Override
                        public void call() {
                            if (ch != null) {
                                ...
                                if (pos == -1 || SpacebaseRun.bossLevel()) {
                                    ...
                                    GLog.w(Messages.get(PortableMaker.class, "tele_fail"));
        ...
        public String prompt() {
            return Messages.get(PortableMaker.class, "prompt");
        }
    };
    ...
    private class beaconRecharge extends ModuleBuff {
        @Override
        public boolean act() {
