...
public class ScriptOfUpgrade extends InventoryScript {
    ...
    private static void tweakMalfunction(Hero hero) {
        GLog.p(Messages.get(ScriptOfUpgrade.class, "tweak_malfunction"));
        hero.sprite.emitter().start(ShadowParticle.UP, 0.05f, 5);
    }

    private static void fix(Hero hero) {
        GLog.p(Messages.get(ScriptOfUpgrade.class, "fix"));
