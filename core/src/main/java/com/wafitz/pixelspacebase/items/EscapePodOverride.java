...
public class EscapePodOverride extends Item {

    private static final String AC_END = "END";

    {
        image = ItemSpriteSheet.ESCAPE_POD_OVERRIDE;
    ...
    private void showAmuletScene(boolean showText) {
        try {
            ...
            EscapePodScene.noText = !showText;
            Game.switchScene(EscapePodScene.class);
        } catch (IOException e) {
