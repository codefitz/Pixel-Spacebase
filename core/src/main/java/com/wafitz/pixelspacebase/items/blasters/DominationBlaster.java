...
public class DominationBlaster extends Blaster {

    {
        image = ItemSpriteSheet.MINDBLASTER;
    }
    ...
    protected void onZap(Ballistica bolt) {
        ...
        if (ch != null) {
            ...
            if (ch.buff(Domination.class) != null) {
            ...
            //if we fail, lose all charges, remember we have 1 left to lose from using the blaster.
            ...
            Buff.append(ch, Domination.class);
            ch.HP = ch.HT;
    ...
    public void onHit(DM3000Launcher launcher, Char attacker, Char defender, int damage) {
        ...
        if (Random.Int(level() + 4) >= 3) {
            Buff.prolong(defender, Paranoid.class, 3 + level());
        }
    }
