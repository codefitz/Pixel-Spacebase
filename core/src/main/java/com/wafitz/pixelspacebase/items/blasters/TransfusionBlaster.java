...
public class TransfusionBlaster extends Blaster {
    ...
    protected void onZap(Ballistica beam) {
        ...
        if (ch != null && ch instanceof Mob) {
            ...
            //30% + 3%*lvl chance to grow a random triggers, or just regrow lightedvent.
            if (Random.Float() <= 0.3f + level() * 0.03f) {
                Dungeon.level.trigger((Trigger.Gadget) Generator.random(Generator.Category.GADGET), cell);
