...
public class TechToolkit extends EquippableModule {

    {
        image = ItemSpriteSheet.TECH_TOOLKIT;
    ...
    private static final String DEVICESTOTECH = "devicestotech";
    ...
    public void storeInBundle(Bundle bundle) {
        ...
        bundle.put(DEVICESTOTECH, devicesToTech);
    ...
    public void restoreFromBundle(Bundle bundle) {
        ...
        devicesToTech = bundle.getInt(DEVICESTOTECH);
    ...
    public class crafting extends ModuleBuff {

        public boolean tryMake(int count) {

            //this logic is handled inside the class with a variable so that it may be stored.
            //to prevent manipulation where a player could keep throwing in 1-2 devices until they get lucky.
            if (devicesToTech == 0) {
