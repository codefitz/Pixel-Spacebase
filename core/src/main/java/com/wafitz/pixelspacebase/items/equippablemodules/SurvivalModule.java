...
public class SurvivalModule extends EquippableModule {
    ...
    protected WndContainer.Mode mode = WndContainer.Mode.FOOD;
    ...
    public class hornRecharge extends ModuleBuff {
        ...
        public void onSelect(Item item) {
            if (item != null && item instanceof Food) {
                if (item instanceof AlienPod && ((AlienPod) item).experimentalTechAttrib == null) {
                    ...
                    if (curItem.level() >= 30) {
                        curItem.level(30);
                        GLog.p(Messages.get(SurvivalModule.class, "maxlevel"));
                    } else
                        GLog.p(Messages.get(SurvivalModule.class, "levelup"));
