...
public class FreezeThrower extends DamageBlaster {
    ...
    public void onHit(DM3000Launcher launcher, Char attacker, Char defender, int damage) {
        ...
        if (chill != null && Random.IntRange(2, 10) > chill.cooldown()) {
            //need to delay this through an actor so that the freezing isn't broken by taking damage from the launcher hit.
            new FlavourBuff() {
                {
