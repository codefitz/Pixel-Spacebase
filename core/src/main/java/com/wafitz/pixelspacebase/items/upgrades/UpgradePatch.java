...
public class UpgradePatch extends InventoryUpgrade {
    ...
    private static void tweakMalfunction(Hero hero) {
        GLog.p(Messages.get(UpgradePatch.class, "tweak_malfunction", curItem.name()));
        hero.sprite.emitter().start(ShadowParticle.UP, 0.05f, 5);
    }

    private static void fix(Hero hero) {
        GLog.p(Messages.get(UpgradePatch.class, "fix", curItem.name()));
