...
public class TrainingManual extends Item {
        ...
        if (action.equals(AC_READ)) {
            ...
            switch (hero.heroClass) {
                ...
                case DM3000:
                    ...
                    way2 = HeroSubClass.SIGNAL_LEECH;
                    break;
                case SHAPESHIFTER:
    ...
    public void choose(HeroSubClass way) {
        ...
        curUser.spend(TrainingManual.TIME_TO_READ);
        curUser.busy();
        ...
        EffectSprite.show(curUser, EffectSprite.MASTERY);
