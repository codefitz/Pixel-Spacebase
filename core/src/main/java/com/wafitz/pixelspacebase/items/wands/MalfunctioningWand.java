...
//helper class to contain all the malfunctioning wand zapping logic, so the main wand class doesn't get huge.
class MalfunctioningWand {
    ...
    static void malfunctioningZap(final Wand wand, final Hero user, final Ballistica bolt) {
    ...
    private static void commonEffect(final Wand wand, final Hero user, final Ballistica bolt) {
        switch (Random.Int(4)) {
            ...
            case 2:
                switch (Random.Int(2)) {
                    case 0:
                        ScriptOfTeleportation.teleportHero(user);
                        wand.wandUsed();
                        break;
                    case 1:
                        malfunctioningFX(user, bolt, new Callback() {
        ...
        switch (Random.Int(4)) {
            ...
            case 1:
                ...
                if (target != null) {
                            ...
                            switch (Random.Int(2)) {
                                ...
                                case 1:
                                    ...
                                    if (!user.isAlive()) {
                                        ...
                                        GLog.n(Messages.get(MalfunctioningWand.class, "ondeath", wand.name()));
                                    }
                                    break;
                            }
                            wand.wandUsed();
                    ...
                    GLog.i(Messages.get(MalfunctioningWand.class, "nothing"));
                    wand.wandUsed();
                }
                break;
            ...
            case 3:
                ...
                ScriptOfRecharging.charge(user);
    ...
    private static void veryRareEffect(final Wand wand, final Hero user, final Ballistica bolt) {
        switch (Random.Int(4)) {
            ...
            case 0:
                ...
                GLog.p(Messages.get(MalfunctioningWand.class, "lightedvent"));
                GLog.w(Messages.get(MalfunctioningWand.class, "fire"));
                wand.wandUsed();
                break;
                    ...
                    public void call() {
                        ...
                        do {
                            reward = Generator.random(Random.oneOf(Generator.Category.WEAPON, Generator.Category.ARMOR,
                                    Generator.Category.MODULE, Generator.Category.WAND));
            ...
            case 2:
                try {
                    ...
                    if (Messages.lang() != Languages.ENGLISH) {
                        ...
                        GameScene.show(
                                new WndOptions("MALFUNCTIONING WAND ERROR", "this application will now self-destruct", "abort", "retry", "fail") {
                                    @Override
                                    public void hide() {
            ...
            case 3:
                ...
                GLog.w(Messages.get(MalfunctioningWand.class, "transmogrify"));
