...
public class TimeFolder extends EquippableModule {
                        ...
                        new WndOptions(Messages.get(this, "name"),
                            ...
                            protected void onSelect(int index) {
                                if (index == 0) {
                                    ...
                                    activeBuff.attachTo(SpacebaseRun.hero);
                                } else if (index == 1) {
    ...
    private class hourglassRecharge extends ModuleBuff {
        @Override
        public boolean act() {
    ...
    public class timeStasis extends ModuleBuff {
    ...
    public class timeFreeze extends ModuleBuff {
