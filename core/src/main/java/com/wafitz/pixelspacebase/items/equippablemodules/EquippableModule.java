...
public class EquippableModule extends KindofMisc {
    ...
    public boolean doEquip(final Hero hero) {
        ...
        if ((hero.belongings.misc1 != null && hero.belongings.misc1.getClass() == this.getClass())
            ...
            GLog.w(Messages.get(EquippableModule.class, "limited_to_two"));
            return false;
    ...
    @Override
    public String info() {
        if (malfunctioning && malfunctioningKnown && !isEquipped(SpacebaseRun.hero)) {

            return desc() + "\n\n" + Messages.get(EquippableModule.class, "malfunction_known");
    ...
    String convertName(String className) {
        ...
        className = className.replaceFirst("Upgrade|Tech", "");
    ...
    protected ModuleBuff activeBuff() {
        return null;
    }
