...
public class StrongForcefield extends EquippableModule {
    ...
    public class Shield extends ModuleBuff {
        ...
        public int proc(int damage, Char attacker, Char defender) {
            ...
            if (cooldown != 0) {
                ...
                if (attacker != null && SpacebaseRun.level.adjacent(attacker.pos, defender.pos)) {
