...
| Armor | Defensive equipment with strength requirements, upgrades, malfunctions, and enhancements. Space suits and hunter suits protect biological heroes on exposed bridge walks outside the station. When equipped with floor lights off, the Hunter Suit shows red silhouettes for enemies and NPCs through fog without revealing terrain or changing targeting sight. Its jetpack toggles unlimited flight on or off while equipped; it powers down when the suit is removed, and landing over a chasm triggers a fall. The Hoverpod absorbs landed hits and avoids non-explosive traps; its visible integrity starts at 15 hits, and it is destroyed in an explosion when depleted. Explosions bypass its protection. The Repair Blaster restores its integrity, and combining two Hoverpods at Leonard's workstation restores and increases maximum integrity by one. |
