# Pixel Spacebase Story Beats

This document records the story shape currently present in code and message resources. It is a working canon map, not final prose.

## Core Premise

Pixel Spacebase has been abandoned after a multi-faction breach. The crew have fled or disappeared, service systems are failing, and hostile lifeforms, raiders, corrupted prisoners, old machines, and deeper extradimensional threats now control the decks.

The player character returns to take back control of the station, survive the descent, and reach the escape/end-game artifact path. Current class-facing text supports four playable identities:
...
### Floor 5: Maintenance Boss

Boss: Feral Shapeshifter.
...
- Move below crew-facing decks into older, stranger infrastructure.
- Introduce heavier biological and mechanical threats.
- Surface Chief Engineer Leonard as a survivor trying to restore power.

Current side content:

- Leonard needs parts or protection while trying to get station power back online.
- He rewards useful gear work and reinforces that Pixel Spacebase can still be repaired.

### Floor 15: Lower Engineering Boss
...
- A final preparation floor before the deepest threat.
- With the current mechanics, workshops are present throughout the run, but this still functions as a final breather and resupply point.
...
### Hologram Distress Call

NPC: Princess Pixel of Yendor, via hologram.

Current variants:

- Evolved xenomorph threat: warns about acid blood and staying near water.
- Dark Lord of Yendor: diplomatic mission intercepted by a dangerous Yendor figure with toxin/incendiary flechettes.
- Armored maintenance crawler: asks the player to disable a giant crawler with a shield claw.

Story role:

- Gives early optional objectives and reinforces the station as connected to Yendor politics, imported xenomorphs, and malfunctioning maintenance hardware.

### Chief Engineer Leonard

NPC: Chief Engineer Leonard.
...
- Current comic/meta side quest.
- Can remain as an extradimensional anomaly or be replaced by a more grounded Pixel Spacebase character later.

### Queen Xenomorph

NPC/encounter: Queen Xenomorph.

Current beat:

- Cause of excessive xenomorph breeding on Pixel Spacebase.
- Has a dismissive personality and calls xenomorphs her children.

Story role:

- Strong candidate for a fuller optional xenomorph side story or area event.
...
Use the existing mechanics as the skeleton:

1. Maintenance establishes the failed station and xenomorph/shapeshifter incidents.
