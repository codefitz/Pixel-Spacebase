...
| `MakerBotSprite` | `makerbot.png` | 128x64 | 56x56 | 2x1 | 2 | 1 | Sheet dimensions are not an exact multiple of frame size. |
...
| `OldWarBotSprite` | `war_bot.png` | 864x180 | 48x60 | 18x3 | 54 | 16 | Sheet dimensions are not an exact multiple of frame size. |
...
| `QueenXenoSprite` | `xqueen.png` | 512x256 | 64x68 | 8x3 | 24 | 7 | Sheet dimensions are not an exact multiple of frame size. |
| `ReplicatorSwarmSprite` | `swarm.png` | 1024x64 | 64x64 | 16x1 | 16 | 15 |  |
...
| `WaterThingSprite` | `water_things.png` | 1024x64 | 48x64 | 21x1 | 21 | 15 | Sheet dimensions are not an exact multiple of frame size. |
